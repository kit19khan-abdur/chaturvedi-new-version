...
export const RenderSix = ({ stepData, setStepData, setRequiredFields }) => {
  ...
  return (
    ...
    <div className="capitalize p-4 rounded-xl ">
      ...
      {(stepData.paymentStatus === 'Full Payment Received') && (
        <StepSixCheckBox setRequiredFields={setRequiredFields} title={"Payment by Customer"} stepData={stepData} setStepData={setStepData} paymentStatus={stepData.paymentStatus} />
      )}
