...
export const RenderSeven = ({ handleChangeStep, stepData, setStepData, setRequiredFields }) => {
      const callExecutivesOptions = [
    { value: 'Archana Chaturvedi', label: 'Archana Chaturvedi' },
    { value: 'Reena', label: 'Reena' },
  ];
  ...
  const underwriterOptions = [
    { value: '', label: 'Select' },
    { value: 'Hardik Kulshrestha', label: 'Hardik Kulshrestha' },
    { value: 'Bhupendra', label: 'Bhupendra' },
    { value: 'Nitesh Chaudhary', label: 'Nitesh Chaudhary' },
    { value: 'Manjit', label: 'Manjit' },
    { value: 'Gaurav Yadav', label: 'Gaurav Yadav' },
  ];
  ...
  const handleSelectChange = (selected, { name }) => {
    ...
    useEffect(() => {
      ...
      fields.push("callExecutiveRefs","fieldExecutiveRefs","policyUnderwriter","pucAvailable")
  ...
  return (
    ...
    <div className="capitalize p-4 rounded-xl space-y-4">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <label className="block font-medium mb-1">
            Policy Underwriter Executive Reference <span className="text-[#f00]">*</span>
          </label>
          <select
        ...
        <div>
          <label className="block font-medium mb-1">PUC Available <span className="text-[#f00]">*</span></label>
          <select
            name="pucAvailable"
