...
export const condition1 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
    handleAddonsChange,
...
export const condition2 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition3 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition4 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition5 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition6 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition7 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition8 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
...
export const condition9 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const { insurerOptions } = data;
  return (
    <>
...
export const condition10 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition11 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition12 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition13 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition14 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition15 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition16 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition17 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition18 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition19 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
...
export const condition20 = ({ handleChangeStep, stepData, setStepData }) => {
  const data = Alloption(stepData);
  const {
    addonOptions,
    CheckboxOption,
